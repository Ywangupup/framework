        ...
        <div class="history">
            <div class="history-date">
                <ul>
                    ...
                    <li>
                        <form action="<?= \yii\helpers\Url::toRoute('msg/index')?>" method="post">
                            <dl>
                                <dt>
                                    <input name="created_at" type="text" class="px" id="created_at" value="<?= $created_at?>" autocomplete="off" placeholder="请选择查找开始时间">
                                </dt>
                                <dt>
                                    <input name="updated_at" type="text" class="px" id="updated_at" value="<?= $updated_at?>" autocomplete="off" placeholder="请选择查找结束时间">
                                </dt>
                                <dt>
                                    <input  type="submit" value="查找留言" style="background-color: #1CC200; width: 120px;height: 30px;" >
                                </dt>
                            </dl>
                        </form>
                    </li>
